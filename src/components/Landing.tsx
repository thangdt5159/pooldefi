  ...
  return (
    <section className="wrapper w-full h-screen text-white">
      <div className="landing-header relative md:h-full h-[75%] mt-[-165px] md:mt-0">
        <div className="background-image absolute w-full h-[85%] md:h-full bg-landingBg bg-no-repeat bg-cover bg-center md:bg-center object-cover z-[-1]">
